...
import net.madz.stochastic.utilities.annotations.PerCaseSetup;
import net.madz.stochastic.utilities.annotations.PerThreadSetup;
...
public class DynamicTestRunnable implements Runnable {
    ...
    private void doRunTest() {
        ...
        for ( Annotation annotation : annotations ) {
            ...
            if ( null != perCase ) {
                dynamicTestProcessor.processAnnotation(context, annotation);
            }
        }
