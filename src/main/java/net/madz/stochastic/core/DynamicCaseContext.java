...
import net.madz.stochastic.core.impl.dimensions.AbstractDimension;
import net.madz.stochastic.core.report.Cell;
import net.madz.stochastic.core.report.MergeableCell;
